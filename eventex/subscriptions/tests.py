...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Flávio Henrique Ferreira', email.body)
        self.assertIn('11111111120', email.body)
        self.assertIn('flaviometalvale@gmail.com', email.body)
        self.assertIn('16 99208-4635', email.body)
...
class SubscribeSuccessMessage(TestCase):
    def test_message(self):
        data = data = dict(name='Flávio Henrique Ferreira', cpf='11111111120',
                           email='flaviometalvale@gmail.com', phone='16 99208-4635')
